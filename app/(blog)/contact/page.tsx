...
function page() {
  return (
    <div className="bg-gray-50 py-6 my-7">
        ...
        <div className="flex-shrink max-w-full w-full lg:w-2/3  overflow-hidden">
          <div className="w-full py-3">
            <h2 className="text-gray-800 text-3xl font-bold">
              <span className="inline-block h-5 border-l-3 border-red-600 mr-2"></span> Contact Us
            </h2>
          </div>
            ...
            <div className="flex-shrink max-w-full w-full px-3 pb-5">
              <div className="px-8 py-6 border border-gray-100 bg-white">
                <form className="flex flex-wrap flex-row -mx-4">
                  ...
                  <div className="flex-shrink max-w-full px-4 w-full md:w-1/2 mb-6">
                    <label htmlFor="inputurgent" className="inline-block mb-2">Urgency</label>
                  ...
                  <div className="flex-shrink max-w-full px-4 w-full mb-6">
                    <label htmlFor="exampleTextarea1" className="inline-block mb-2">Messages</label>
                    <textarea className="w-full leading-5 relative py-3 px-5 text-gray-800 bg-white border border-gray-100 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0 dark:text-gray-400 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600" id="exampleTextarea1"></textarea>
                  </div>
                  <div className="flex-shrink max-w-full px-4 w-full mb-6">
                    <label className="flex items-center">
                      <input type="checkbox" name="checked-demo" value="1" className="form-checkbox h-5 w-5 text-blue-500 dark:bg-gray-700 border border-gray-100 dark:border-gray-700 focus:outline-none" required />
                      <span className="text-gray-700 ml-4">I agree to the Terms of Use</span>
                    </label>
                  </div>
